...
class Vector
{
  public:
      ...
      // Inidicates that no item was found in bsearch
		static const int NO_INDEX = -1;
    
      // For the sorting function
    struct SortResult
    {
      unsigned compares; // The number of comparisons during the sort
      unsigned swaps;    // The number of swaps during the sort
    };    
