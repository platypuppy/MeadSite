...
int main(int argc, char **argv)
{
  ...
  if (test == 1)
    ...
    test_rect(7, 10, 15, false, false);
  else if (test == 5)
    test_rect(7, 10, 15, true, false);
  else if (test == 6)
    test_rect(7, 10, 15, true, true);
  else if (test == 7)
    test_rect(50, 30, 30, false, false);
  else if (test == 8)
    test_rect(50, 30, 30, true, false);
  else if (test == 9)
    test_rect(50, 30, 30, true, true);
